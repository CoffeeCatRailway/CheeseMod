...
public class WorldGenTreeHamCooked extends WorldGenAbstractTree {

	public static final IBlockState LOG = InitBlock.LOG_HAM_COOKED.getDefaultState();
	public static final IBlockState LEAVES = InitBlock.LEAVES_HAM_COOKED.getDefaultState();

	private int minHeight;

	public WorldGenTreeHamCooked() {
		super(false);
		this.minHeight = 7;
	}
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		...
		if (!flag) {
			...
			boolean isSoil = state.getBlock().canSustainPlant(state, world, down, EnumFacing.UP, (BlockBaseSapling) InitBlock.SAPLING_HAM_COOKED);
