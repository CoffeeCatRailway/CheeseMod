...
public class WorldGenTreeCheese extends WorldGenAbstractTree {

	public static final IBlockState LOG = InitBlock.LOG_CHEESE.getDefaultState();
	public static final IBlockState LEAVES = InitBlock.LEAVES_CHEESE.getDefaultState();

	private int minHeight;

	public WorldGenTreeCheese() {
		super(false);
		this.minHeight = 7;
	}
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		...
		if (!flag) {
			...
			boolean isSoil = state.getBlock().canSustainPlant(state, world, down, EnumFacing.UP, (BlockBaseSapling) InitBlock.SAPLING_CHEESE);
