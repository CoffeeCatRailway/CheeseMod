...
public class WorldGenTreeHamRaw extends WorldGenAbstractTree {
    ...
    public static final IBlockState LOG = InitBlock.LOG_HAM_RAW.getDefaultState();
    public static final IBlockState LEAVES = InitBlock.LEAVES_HAM_RAW.getDefaultState();
    ...
    public boolean generate(World world, Random rand, BlockPos pos) {
        ...
        if (!flag) {
            ...
            boolean isSoil = state.getBlock().canSustainPlant(state, world, down, EnumFacing.UP, (BlockBaseSapling) InitBlock.SAPLING_HAM_RAW);
