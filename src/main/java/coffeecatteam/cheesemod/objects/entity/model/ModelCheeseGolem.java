...
public class ModelCheeseGolem extends ModelBase {
	...
	public ModelCheeseGolem() {
		this(0.0F);
	}

	public ModelCheeseGolem(float scale) {
		this(scale, -7.0F);
	}

	public ModelCheeseGolem(float scale, float rotationPointY) {
		int i = 128;
		int j = 128;
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount,
		...
		EntityCheeseGolem golem = (EntityCheeseGolem) entitylivingbaseIn;
