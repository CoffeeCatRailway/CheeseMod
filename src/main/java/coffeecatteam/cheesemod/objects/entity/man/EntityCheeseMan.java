    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand) {
        ...
        if (itemstack.getItem() == InitItem.BREAD_SLICE && !player.capabilities.isCreativeMode && !this.isChild()) {
            ...
            if (itemstack.isEmpty()) {
                player.setHeldItem(hand, new ItemStack(InitItem.TOASTIE_CHEESE));
            } else if (!player.inventory.addItemStackToInventory(new ItemStack(InitItem.TOASTIE_CHEESE))) {
                player.dropItem(new ItemStack(InitItem.TOASTIE_CHEESE), false);
            }
