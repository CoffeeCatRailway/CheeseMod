...
import coffeecatteam.cheesemod.objects.entity.ai.ham.EntityAIDefendHamMan;
import coffeecatteam.cheesemod.objects.entity.ai.ham.EntityAILookAtHamMan;
...
public class EntityHamGolem extends EntityGolem {

	protected static final DataParameter<Byte> PLAYER_CREATED = EntityDataManager
			.<Byte>createKey(EntityHamGolem.class, DataSerializers.BYTE);
	...
	protected void initEntityAI() {
		...
		this.tasks.addTask(5, new EntityAILookAtHamMan(this));
		this.tasks.addTask(6, new EntityAIWanderAvoidWater(this, 0.6D));
		this.tasks.addTask(7, new EntityAIWatchClosest(this, EntityPlayer.class, 6.0F));
		this.tasks.addTask(8, new EntityAILookIdle(this));
		this.targetTasks.addTask(1, new EntityAIDefendHamMan(this));
	...
	public static void registerFixesIronGolem(DataFixer fixer) {
		EntityLiving.registerFixesMob(fixer, EntityHamGolem.class);
	}
