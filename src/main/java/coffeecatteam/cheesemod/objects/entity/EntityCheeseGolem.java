...
import coffeecatteam.cheesemod.objects.entity.ai.cheese.EntityAIDefendCheeseMan;
import coffeecatteam.cheesemod.objects.entity.ai.cheese.EntityAILookAtCheeseMan;
...
public class EntityCheeseGolem extends EntityGolem {

	protected static final DataParameter<Byte> PLAYER_CREATED = EntityDataManager
			.<Byte>createKey(EntityCheeseGolem.class, DataSerializers.BYTE);
	...
	public EntityCheeseGolem(World world) {
		super(world);
	...
	protected void initEntityAI() {
		...
		this.tasks.addTask(5, new EntityAILookAtCheeseMan(this));
		this.tasks.addTask(6, new EntityAIWanderAvoidWater(this, 0.6D));
		this.tasks.addTask(7, new EntityAIWatchClosest(this, EntityPlayer.class, 6.0F));
		this.tasks.addTask(8, new EntityAILookIdle(this));
		this.targetTasks.addTask(1, new EntityAIDefendCheeseMan(this));
	...
	public static void registerFixesIronGolem(DataFixer fixer) {
		EntityLiving.registerFixesMob(fixer, EntityCheeseGolem.class);
	}
