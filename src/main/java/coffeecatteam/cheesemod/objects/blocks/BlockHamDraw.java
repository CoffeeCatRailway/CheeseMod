...
public class BlockHamDraw extends BlockBase implements ITileEntityProvider {

	public static final PropertyDirection FACING = BlockHorizontal.FACING;

	public BlockHamDraw(String name, float hardness, float resistance, Material material, int harvestLevel) {
		super(name, hardness, resistance, material, "axe", harvestLevel, CheeseMod.CHEESETAB);
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
		...
		TileEntityHamDraw te = (TileEntityHamDraw) world.getTileEntity(pos);
		if (te != null && te.hasCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, EnumFacing.NORTH)) {
			player.openGui(CheeseMod.instance, GuiHandler.HAM_DRAW_GUI_ID, world, pos.getX(), pos.getY(),
					pos.getZ());
		}
		return true;
	}
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileEntityHamDraw();
	}

	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(InitBlock.HAM_DRAW);
	}
