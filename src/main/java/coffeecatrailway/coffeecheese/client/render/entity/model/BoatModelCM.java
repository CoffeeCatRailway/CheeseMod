 ...
 */
@OnlyIn(Dist.CLIENT)
public class BoatModelCM extends SegmentedModel<BoatEntityCM> {
    ...
    @Override
    public void setRotationAngles(BoatEntityCM entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    protected void func_228244_a_(BoatEntityCM p_228244_1_, int p_228244_2_, float p_228244_3_) {
