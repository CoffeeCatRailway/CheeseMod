 ...
 */
@OnlyIn(Dist.CLIENT)
public class BoatModelCM extends EntityModel<BoatEntityCM> {
    ...
    public void render(BoatEntityCM entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    public void renderMultipass(Entity entity, float partialTicks, float p_187054_3_, float p_187054_4_, float p_187054_5_, float p_187054_6_, float scale) {
        GlStateManager.rotatef(90.0F, 0.0F, 1.0F, 0.0F);
    ...
    protected void renderPaddle(BoatEntityCM boat, int paddle, float scale, float limbSwing) {
