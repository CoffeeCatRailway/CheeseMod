...
public class FoodWorldPortalTileEntityRenderer extends TileEntityRenderer<FoodWorldPortalTileEntity> {
    ...
    public void render(FoodWorldPortalTileEntity tile, double x, double y, double z, float partialTicks, int destroyStage) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            float r = (RANDOM.nextFloat() * 0.8f + 0.8f) * f1;
            float g = (RANDOM.nextFloat() * 0.7f + 0.4f) * f1;
            float b = (RANDOM.nextFloat() * 0.4f + 0.3f) * f1;
