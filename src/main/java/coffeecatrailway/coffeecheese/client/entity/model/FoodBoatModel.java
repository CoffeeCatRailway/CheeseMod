 ...
 */
@OnlyIn(Dist.CLIENT)
public class FoodBoatModel extends SegmentedModel<FoodBoatEntity> {
    ...
    @Override
    public void setRotationAngles(FoodBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    protected void func_228244_a_(FoodBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
