 ...
 * Created: 24/07/2020
 */
public class HamSuitModel extends BipedModel<LivingEntity> {
    ...
    public HamSuitModel(float scale, EquipmentSlotType armorSlot) {
        super(scale, 0, 64, 32);

        float scaleSuit = (float) (scale * CheeseMod.CLIENT_CONFIG.hamSuitScale.get());
        float scaleBinding = (float) (scale * (CheeseMod.CLIENT_CONFIG.hamSuitScale.get() - CheeseMod.CLIENT_CONFIG.hamSuitBindingScale.get()));
