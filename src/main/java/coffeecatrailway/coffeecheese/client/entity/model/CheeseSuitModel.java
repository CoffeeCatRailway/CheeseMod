package coffeecatrailway.coffeecheese.client.entity.model;
 ...
 * Created: 24/07/2020
 */
public class CheeseSuitModel extends BipedModel<LivingEntity> {
    ...
    public CheeseSuitModel(float scale) {
        super(scale, 0, 64, 32);

        float scaleSuit = (float) (scale * CheeseMod.CLIENT_CONFIG.cheeseSuitScale.get());
        float scaleBinding = (float) (scale * (CheeseMod.CLIENT_CONFIG.cheeseSuitScale.get() - CheeseMod.CLIENT_CONFIG.cheeseSuitBindingScale.get()));
