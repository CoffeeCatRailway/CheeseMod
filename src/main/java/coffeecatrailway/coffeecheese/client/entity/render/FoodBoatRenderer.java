package coffeecatrailway.coffeecheese.client.entity.render;

import coffeecatrailway.coffeecheese.CheeseMod;
import coffeecatrailway.coffeecheese.client.entity.model.FoodBoatModel;
 ...
 */
@OnlyIn(Dist.CLIENT)
public class FoodBoatRenderer extends EntityRenderer<FoodBoatEntity> {
    ...
    protected final FoodBoatModel boatModel = new FoodBoatModel();

    public FoodBoatRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
        this.shadowSize = 0.8F;
    }

    @Override
    public void render(FoodBoatEntity boat, float yaw, float partialTicks, MatrixStack matrix, IRenderTypeBuffer buffer, int packedLight) {
        matrix.push();
    ...
    @Override
    public ResourceLocation getEntityTexture(FoodBoatEntity entity) {
