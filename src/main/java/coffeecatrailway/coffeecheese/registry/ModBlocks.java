...
public class ModBlocks {
    ...
    /// Nature ///
    public static final RegistryObject<TallFoodGrassBlock> CHEESE_GRASS = registerBlockGeneral("cheese_grass", () -> new TallFoodGrassBlock(Block.Properties.create(Material.TALL_PLANTS).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)));
    public static final RegistryObject<TallFoodGrassBlock> GRILLED_CHEESE_GRASS = registerBlockGeneral("grilled_cheese_grass", () -> new TallFoodGrassBlock(Block.Properties.create(Material.TALL_PLANTS).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)));
    public static final RegistryObject<TallFoodGrassBlock> HAM_RAW_GRASS = registerBlockGeneral("ham_raw_grass", () -> new TallFoodGrassBlock(Block.Properties.create(Material.TALL_PLANTS).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)));
    public static final RegistryObject<TallFoodGrassBlock> HAM_COOKED_GRASS = registerBlockGeneral("ham_cooked_grass", () -> new TallFoodGrassBlock(Block.Properties.create(Material.TALL_PLANTS).doesNotBlockMovement().zeroHardnessAndResistance().sound(SoundType.PLANT)));

    public static final RegistryObject<Block> CHEESE_GRASS_BLOCK = registerBlockGeneral("cheese_grass_block", () -> new FoodGrassBlock(Block.Properties.create(Material.ORGANIC).tickRandomly().hardnessAndResistance(0.6F).sound(SoundType.PLANT), CHEESE_GRASS.get().getDefaultState()));
    public static final RegistryObject<Block> GRILLED_CHEESE_GRASS_BLOCK = registerBlockGeneral("grilled_cheese_grass_block", () -> new FoodGrassBlock(Block.Properties.create(Material.ORGANIC).tickRandomly().hardnessAndResistance(0.6F).sound(SoundType.PLANT), GRILLED_CHEESE_GRASS.get().getDefaultState()));
    public static final RegistryObject<Block> HAM_RAW_GRASS_BLOCK = registerBlockGeneral("ham_raw_grass_block", () -> new FoodGrassBlock(Block.Properties.create(Material.ORGANIC).tickRandomly().hardnessAndResistance(0.6F).sound(SoundType.PLANT), HAM_RAW_GRASS.get().getDefaultState()));
    public static final RegistryObject<Block> HAM_COOKED_GRASS_BLOCK = registerBlockGeneral("ham_cooked_grass_block", () -> new FoodGrassBlock(Block.Properties.create(Material.ORGANIC).tickRandomly().hardnessAndResistance(0.6F).sound(SoundType.PLANT), HAM_COOKED_GRASS.get().getDefaultState()));
