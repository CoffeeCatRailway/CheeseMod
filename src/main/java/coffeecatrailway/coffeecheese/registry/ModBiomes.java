...
public class ModBiomes {
    ...
    public static final RegistryObject<FoodBiome> CHEESE_FOREST = BIOMES.register("cheese_forest", () ->
            new FoodBiome(CHEESE_WATER_COLOR, CHEESE_WATER_FOG_COLOR, CHEESE_GRASS_COLOR,
                    Blocks.GRASS_BLOCK.getDefaultState(), ModFeatures.CHEESE_TREE, ModFeatures.GRILLED_CHEESE_TREE, null));
    public static final RegistryObject<FoodBiome> CHEESE_PLAINS = BIOMES.register("cheese_plains", () ->
            new FoodBiome(CHEESE_WATER_COLOR, CHEESE_WATER_FOG_COLOR, CHEESE_GRASS_COLOR,
                    Blocks.GRASS_BLOCK.getDefaultState(), FoodBiome.getParent(CHEESE_FOREST.get())));
    ...
    public static final RegistryObject<FoodBiome> GRILLED_CHEESE_FOREST = BIOMES.register("grilled_cheese_forest", () ->
            new FoodBiome(GRILLED_CHEESE_WATER_COLOR, GRILLED_CHEESE_WATER_FOG_COLOR, GRILLED_CHEESE_GRASS_COLOR,
                    Blocks.GRASS_BLOCK.getDefaultState(), ModFeatures.GRILLED_CHEESE_TREE, ModFeatures.CHEESE_TREE, null));
    public static final RegistryObject<FoodBiome> GRILLED_CHEESE_PLAINS = BIOMES.register("grilled_cheese_plains", () ->
            new FoodBiome(GRILLED_CHEESE_WATER_COLOR, GRILLED_CHEESE_WATER_FOG_COLOR, GRILLED_CHEESE_GRASS_COLOR,
                    Blocks.GRASS_BLOCK.getDefaultState(), FoodBiome.getParent(GRILLED_CHEESE_FOREST.get())));
    ...
    public static final RegistryObject<FoodBiome> HAM_RAW_FOREST = BIOMES.register("ham_raw_forest", () ->
            new FoodBiome(HAM_RAW_WATER_COLOR, HAM_RAW_WATER_FOG_COLOR, HAM_RAW_GRASS_COLOR,
                    Blocks.GRASS_BLOCK.getDefaultState(), ModFeatures.HAM_RAW_TREE, ModFeatures.HAM_COOKED_TREE, null));
    public static final RegistryObject<FoodBiome> HAM_RAW_PLAINS = BIOMES.register("ham_raw_plains", () ->
            new FoodBiome(HAM_RAW_WATER_COLOR, HAM_RAW_WATER_FOG_COLOR, HAM_RAW_GRASS_COLOR,
                    Blocks.GRASS_BLOCK.getDefaultState(), FoodBiome.getParent(HAM_RAW_FOREST.get())));
    ...
    public static final RegistryObject<FoodBiome> HAM_COOKED_FOREST = BIOMES.register("ham_cooked_forest", () ->
            new FoodBiome(HAM_COOKED_WATER_COLOR, HAM_COOKED_WATER_FOG_COLOR, HAM_COOKED_GRASS_COLOR,
                    Blocks.GRASS_BLOCK.getDefaultState(), ModFeatures.HAM_COOKED_TREE, ModFeatures.HAM_RAW_TREE, null));
    public static final RegistryObject<FoodBiome> HAM_COOKED_PLAINS = BIOMES.register("ham_cooked_plains", () ->
            new FoodBiome(HAM_COOKED_WATER_COLOR, HAM_COOKED_WATER_FOG_COLOR, HAM_COOKED_GRASS_COLOR,
                    Blocks.GRASS_BLOCK.getDefaultState(), FoodBiome.getParent(HAM_COOKED_FOREST.get())));
    ...
    public static void addBiomeTypes() {
        ...
        BiomeManager.addBiome(BiomeManager.BiomeType.COOL, new BiomeManager.BiomeEntry(CHEESE_FOREST.get(), 35));
        BiomeManager.addBiome(BiomeManager.BiomeType.COOL, new BiomeManager.BiomeEntry(CHEESE_PLAINS.get(), 35));
        ...
        BiomeManager.addBiome(BiomeManager.BiomeType.WARM, new BiomeManager.BiomeEntry(GRILLED_CHEESE_FOREST.get(), 25));
        BiomeManager.addBiome(BiomeManager.BiomeType.WARM, new BiomeManager.BiomeEntry(GRILLED_CHEESE_PLAINS.get(), 25));
        ...
        BiomeManager.addBiome(BiomeManager.BiomeType.COOL, new BiomeManager.BiomeEntry(HAM_RAW_FOREST.get(), 35));
        BiomeManager.addBiome(BiomeManager.BiomeType.COOL, new BiomeManager.BiomeEntry(HAM_RAW_PLAINS.get(), 35));
        ...
        BiomeManager.addBiome(BiomeManager.BiomeType.WARM, new BiomeManager.BiomeEntry(HAM_COOKED_FOREST.get(), 25));
        BiomeManager.addBiome(BiomeManager.BiomeType.WARM, new BiomeManager.BiomeEntry(HAM_COOKED_PLAINS.get(), 25));
    }
}
