...
public class HamCookedFoodBiome extends BaseFoodBiome {
    ...
    public HamCookedFoodBiome(Category category) {
        super(ModBiomes.HAM_COOKED_WATER_COLOR, ModBiomes.HAM_COOKED_WATER_FOG_COLOR, ModBiomes.HAM_COOKED_GRASS_COLOR, Blocks.GRASS_BLOCK.getDefaultState(), category);
    }
