 ...
 * Created: 15/01/2020
 */
public class FoodWorldChunkGenerator extends NoiseChunkGenerator<FoodWorldChunkGenerator.Config> {
    ...
    public FoodWorldChunkGenerator(World world, BiomeProvider biomeProvider, Config config) {
    ...
    protected void makeBedrock(IChunk chunkIn, Random rand) {
        ...
        FoodWorldChunkGenerator.Config t = this.getSettings();
    ...
    protected void fillNoiseColumn(double[] p_222548_1_, int p_222548_2_, int p_222548_3_) {
        this.func_222546_a(p_222548_1_, p_222548_2_, p_222548_3_, 684.412F, 684.412F, 8.555149841308594D, 4.277574920654297D, 3, -10);
    }
