...
import coffeecatrailway.coffeecheese.client.entity.model.CheeseSuitModel;
 ...
 * Created: 24/07/2020
 */
public class CheeseSuitItem extends ArmorItem {

    public CheeseSuitItem(IArmorMaterial material, EquipmentSlotType slot, Properties properties) {
    ...
    public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
        if (!itemStack.isEmpty()) {
            if (itemStack.getItem() instanceof CheeseSuitItem) {
                CheeseSuitModel armorModel = new CheeseSuitModel(1.0f);
