 ...
 * Created: 16/09/2019
 */
public class BoatItemCM extends Item {

    private static final Predicate<Entity> field_219989_a = EntityPredicates.NOT_SPECTATING.and(Entity::canBeCollidedWith);
    private final BoatEntityCM.Type type;

    public BoatItemCM(BoatEntityCM.Type typeIn, Item.Properties properties) {
        super(properties);
        this.type = typeIn;
        DispenserBlock.registerDispenseBehavior(this, new DispenserBoatBehaviorCM(typeIn));
    }
