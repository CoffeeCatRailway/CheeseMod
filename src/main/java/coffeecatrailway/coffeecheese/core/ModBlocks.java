...
public class ModBlocks {
    ...
    /// Trap Doors ///
    public static Block CHEESE_TRAP_DOOR;
    public static Block GRILLED_CHEESE_TRAP_DOOR;
    public static Block HAM_RAW_TRAP_DOOR;
    public static Block HAM_COOKED_TRAP_DOOR;

    public static Block CHEESE_WOOD_TRAP_DOOR;
    public static Block GRILLED_CHEESE_WOOD_TRAP_DOOR;
    public static Block HAM_RAW_WOOD_TRAP_DOOR;
    public static Block HAM_COOKED_WOOD_TRAP_DOOR;
    ...
    /// Buttons ///
    public static Block CHEESE_BUTTON;
    public static Block GRILLED_CHEESE_BUTTON;
    public static Block HAM_RAW_BUTTON;
    public static Block HAM_COOKED_BUTTON;

    public static Block CHEESE_WOOD_BUTTON;
    public static Block GRILLED_CHEESE_WOOD_BUTTON;
    public static Block HAM_RAW_WOOD_BUTTON;
    public static Block HAM_COOKED_WOOD_BUTTON;
    ...
    public static void registerAll(RegistryEvent.Register<Block> event) {
        ...
        /// Trap Doors ///
        CHEESE_TRAP_DOOR = register("cheese_trap_door", new TrapDoorBlock(Block.Properties.from(CHEESE_BLOCK).hardnessAndResistance(3.0F)));
        GRILLED_CHEESE_TRAP_DOOR = register("grilled_cheese_trap_door", new TrapDoorBlock(Block.Properties.from(GRILLED_CHEESE_BLOCK).hardnessAndResistance(3.0F)));
        HAM_RAW_TRAP_DOOR = register("ham_raw_trap_door", new TrapDoorBlock(Block.Properties.from(HAM_RAW_BLOCK).hardnessAndResistance(3.0F)));
        HAM_COOKED_TRAP_DOOR = register("ham_cooked_trap_door", new TrapDoorBlock(Block.Properties.from(HAM_COOKED_BLOCK).hardnessAndResistance(3.0F)));

        CHEESE_WOOD_TRAP_DOOR = register("cheese_wood_trap_door", new TrapDoorBlock(Block.Properties.from(CHEESE_PLANKS).hardnessAndResistance(3.0F)));
        GRILLED_CHEESE_WOOD_TRAP_DOOR = register("grilled_cheese_wood_trap_door", new TrapDoorBlock(Block.Properties.from(GRILLED_CHEESE_PLANKS).hardnessAndResistance(3.0F)));
        HAM_RAW_WOOD_TRAP_DOOR = register("ham_raw_wood_trap_door", new TrapDoorBlock(Block.Properties.from(HAM_RAW_PLANKS).hardnessAndResistance(3.0F)));
        HAM_COOKED_WOOD_TRAP_DOOR = register("ham_cooked_wood_trap_door", new TrapDoorBlock(Block.Properties.from(HAM_COOKED_PLANKS).hardnessAndResistance(3.0F)));
        ...
        /// Buttons ///
        CHEESE_BUTTON = register("cheese_button", new WoodButtonBlock(Block.Properties.from(CHEESE_BLOCK).doesNotBlockMovement().hardnessAndResistance(0.5F)));
        GRILLED_CHEESE_BUTTON = register("grilled_cheese_button", new WoodButtonBlock(Block.Properties.from(GRILLED_CHEESE_BLOCK).doesNotBlockMovement().hardnessAndResistance(0.5F)));
        HAM_RAW_BUTTON = register("ham_raw_button", new WoodButtonBlock(Block.Properties.from(HAM_RAW_BLOCK).doesNotBlockMovement().hardnessAndResistance(0.5F)));
        HAM_COOKED_BUTTON = register("ham_cooked_button", new WoodButtonBlock(Block.Properties.from(HAM_COOKED_BLOCK).doesNotBlockMovement().hardnessAndResistance(0.5F)));

        CHEESE_WOOD_BUTTON = register("cheese_wood_button", new WoodButtonBlock(Block.Properties.from(CHEESE_PLANKS).doesNotBlockMovement().hardnessAndResistance(0.5F)));
        GRILLED_CHEESE_WOOD_BUTTON = register("grilled_cheese_wood_button", new WoodButtonBlock(Block.Properties.from(GRILLED_CHEESE_PLANKS).doesNotBlockMovement().hardnessAndResistance(0.5F)));
        HAM_RAW_WOOD_BUTTON = register("ham_raw_wood_button", new WoodButtonBlock(Block.Properties.from(HAM_RAW_PLANKS).doesNotBlockMovement().hardnessAndResistance(0.5F)));
        HAM_COOKED_WOOD_BUTTON = register("ham_cooked_wood_button", new WoodButtonBlock(Block.Properties.from(HAM_COOKED_PLANKS).doesNotBlockMovement().hardnessAndResistance(0.5F)));
