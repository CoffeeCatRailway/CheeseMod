package coffeecatrailway.cheesemod.common.entity.item;
 ...
 * Created: 16/09/2019
 */
public class BoatEntityCM extends BoatEntity {

    private static final DataParameter<Integer> TIME_SINCE_HIT = EntityDataManager.createKey(BoatEntityCM.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> FORWARD_DIRECTION = EntityDataManager.createKey(BoatEntityCM.class, DataSerializers.VARINT);
    private static final DataParameter<Float> DAMAGE_TAKEN = EntityDataManager.createKey(BoatEntityCM.class, DataSerializers.FLOAT);
    private static final DataParameter<Integer> BOAT_TYPE = EntityDataManager.createKey(BoatEntityCM.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> field_199704_e = EntityDataManager.createKey(BoatEntityCM.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> field_199705_f = EntityDataManager.createKey(BoatEntityCM.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> ROCKING_TICKS = EntityDataManager.createKey(BoatEntityCM.class, DataSerializers.VARINT);
    ...
    public BoatEntityCM(EntityType<? extends BoatEntity> entityType, World world) {
        ...
        if (!this.isPassenger()) {
            if (onGroundIn) {
                if (this.fallDistance > 3.0F) {
                    if (this.status != BoatEntityCM.Status.ON_LAND) {
