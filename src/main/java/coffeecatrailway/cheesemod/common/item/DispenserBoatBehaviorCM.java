 ...
 * Created: 16/09/2019
 */
public class DispenserBoatBehaviorCM extends DefaultDispenseItemBehavior {

    private final DefaultDispenseItemBehavior defaultDispenseItemBehavior = new DefaultDispenseItemBehavior();
    private final BoatEntityCM.Type type;

    public DispenserBoatBehaviorCM(BoatEntityCM.Type type) {
        this.type = type;
    }
    ...
    public ItemStack dispenseStack(IBlockSource iBlockSource, ItemStack stack) {
        ...
        BoatEntityCM boat = new BoatEntityCM(world, x, y + adjustY, z);
